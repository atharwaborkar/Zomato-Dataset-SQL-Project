...
total amount pratyek customer ni spent kela aahe zomato madhe

Product column lena padega - price,product name,product id 
Sales column lena padega - userid,product_id
...
jevha pan each customer ala aahe yani rank use kela aahe so mi pan ya question mdhe rank use krnar.
...
ya case mdhe aplyala user ani goldusers_signup he tables use kraiche aahet
...
product , user , sales he teen tables vaparnar aapan
